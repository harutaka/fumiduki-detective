...
import QaItem from "../components/QaItem.tsx"
import SearchItem from "../components/SearchItem.tsx"
import Office from "../components/Office.tsx"
import InformationLink from "../components/InformationLink.tsx"
  ...
  return (
    <div class="min-h-screen text-lg tracking-wider bg-gray-100">
      ...
      <main class="relative py-4 px-4 md:px-14">
        {/* site-container */}
        <div class="relative px-4 mx-auto w-full max-w-6xl">
          <section class="mt-8 mb-16 md:my-16">
            <p class="mb-4">
          ...
          <CoverImage class="md:bg-[url('/img/intermiddle01.jpg')]" />
          ...
          <CoverImage class="md:bg-[url('/img/intermiddle02.jpg')]" />
